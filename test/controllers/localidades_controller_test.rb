...
class LocalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localidade" do
    assert_difference('Localidade.count') do
      post localidades_url, params: { localidade: { fecha_limite: @localidade.fecha_limite, precio: @localidade.precio, tipo: @localidade.tipo } }
    end
  ...
  test "should update localidade" do
    patch localidade_url(@localidade), params: { localidade: { fecha_limite: @localidade.fecha_limite, precio: @localidade.precio, tipo: @localidade.tipo } }
