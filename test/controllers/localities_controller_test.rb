...
class LocalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post localities_url, params: { locality: { fecha_limite: @locality.fecha_limite, precio: @locality.precio, tipo: @locality.tipo } }
    end
  ...
  test "should update locality" do
    patch locality_url(@locality), params: { locality: { fecha_limite: @locality.fecha_limite, precio: @locality.precio, tipo: @locality.tipo } }
